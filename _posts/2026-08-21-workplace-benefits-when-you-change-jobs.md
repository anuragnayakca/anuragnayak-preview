...
1. **What coverage ends with the old employer?** Review the benefits booklet or plan summary rather than relying on memory.
2. **When does the new coverage begin?** A waiting period or eligibility date may create a temporary gap.
3. **How different is the new plan?** Compare amounts, definitions, maximums and who pays the premiums.
4. **Do you already have personal coverage?** Personal insurance may continue independently of employment, subject to its policy terms.
